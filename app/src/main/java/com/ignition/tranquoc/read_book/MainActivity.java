...
public class MainActivity extends AppCompatActivity {
    ...
    //tiêu đề bên trái
    private String data[]={"Vợ Nhặt","Vợ chồng A ","Chiếc thuyền ngoài ","Harry Potter Và Mật Lệnh Phượng Hoàng-CHƯƠNG 1","3 Con Heo Con Và Con Sói"};
    @Override
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i){
                    ...
                    case 2:viewPager.setCurrentItem(2);
                        break;
                    case 3:viewPager.setCurrentItem(3);
                        break;
                    default:viewPager.setCurrentItem(4);
                        break;
                }
            }
        });
